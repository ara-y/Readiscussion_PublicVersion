...
public class UserService implements CallUserService{
	...
	public void deleteUser(SiteUser user) {
		...
		//削除　AlreadyReadTimeRepository RoomParticipant_usersRepository をインジェクション。ここで削除の実装。 callDiscussionServiceとは分離する。
		//2日　インスタンスについてJavaGoldにて集中学習。 3日　DIについての学習。削除実装。
	...
	@Override
	public SiteUser registerNewUserAccount(final ForSiteUser userinfo) {

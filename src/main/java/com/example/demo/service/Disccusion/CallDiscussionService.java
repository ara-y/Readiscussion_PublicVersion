...
public interface CallDiscussionService {
	...
	void registerRoom(String endDiscussion, boolean hasPassword, String password, String roomName, String roomURL,SiteUser user, Room saveRoom, GetRoomList room) throws ParseException;
